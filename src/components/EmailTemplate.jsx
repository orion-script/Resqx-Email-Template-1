...
function EmailTemplate() {
  return (
    <div
      className="flex my-7 flex-col  w-[430px] h-[auto] mx-auto shadow-sm colo 
                font-general text-[14px] leading-[20px] font-normal text-[#777777] "
    >
      <div className="bg-[#FF8500] w-[430px] h-[41px]"></div>
      <img src={logo} alt="Logo" className="w-[150px] h-auto" />
      <div className="px-5 ">
        <h2 className="text-[#474747] font-medium">
          Payment Received- ResQ-X service Order #12345{" "}
        </h2>
        <p className="mt-2">Hi John,</p>
        <p>
          We’ve received your payment via bank transfer for the service you
          requested through Resq-X. Here's a breakdown of your transaction:
        </p>{" "}
        <hr className="my-5" />
      </div>
      <div className="px-5 ">
      ...
      <div className="text-[12px] mb-6 px-5">
        ...
        <p>
          Thank you for trusting ResQ-X. We'll get you moving again, fast and
          safe. 🚗⚡
        </p>
      </div>
      <div className="bg-[#FF8500] w-[430px] h-[41px]"></div>
